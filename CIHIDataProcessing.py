...
print('=============================================')
print('List of homes with more than 25 falls in 2015')
for i in HomeIDs2015Above25Falls:
    homeName = dataHome.loc[dataHome['cihi_public_hid']==i]
    print(homeName['name'].values)

print('=============================================')
print('List of homes with more than 25 falls in 2016')
...
def PrintHomeNames(list, year = 2014): #define function
    print('=============================================')
    print('Printing data for year', year)
    for i in list:
        homeName = dataHome.loc[dataHome['cihi_public_hid']==i]
        print(homeName['name'].values)

PrintHomeNames(HomeIDs2014Above25Falls, 2014) #call the function for different years
PrintHomeNames(HomeIDs2015Above25Falls, 2015)
PrintHomeNames(HomeIDs2016Above25Falls, 2016)
